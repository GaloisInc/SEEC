...
(define (demo1)
  (display-changed-abstract-to-heap comp-demo1))
...
(define (demo2)
  (display-changed-abstract-to-heap comp-demo2))

; finds decr on a pointer with P 0 a
...
(define (demo3)
  (display-changed-abstract-to-heap comp-demo3))
...
(define (demo4)
  (display-changed-abstract-to-heap comp-demo4))
...
(define (demo6)
  (display-changed-abstract-to-heap comp-demo6))
...
(define (demo7)
  (display-changed-abstract-to-heap comp-demo7))
